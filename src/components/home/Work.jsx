...
const ProjectCard = ({ project, index }) => {
    ...
    return (
        ...
        >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 md:p-8 z-20 translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                <div className="flex justify-between items-end">
                    <div>
                        <span className="text-brand-red font-medium mb-1 md:mb-2 block text-sm md:text-base">{project.category}</span>
                        <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-white leading-tight">{project.title}</h3>
                    </div>
...
const Work = () => {
    return (
        <section id="work" className="py-16 md:py-24 lg:py-32 bg-black min-h-screen">
            <div className="container mx-auto px-4 md:px-6">
                <div
                    className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 md:mb-12 lg:mb-16 gap-4"
                >
                    <div className="max-w-2xl">
                        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tighter mb-2 md:mb-4 text-white">Selected Work</h2>
