    ...
    return (
        <section ref={containerRef} className="h-[60vh] md:h-[70vh] lg:h-[80vh] py-10 md:py-16 lg:py-20 flex items-center justify-center bg-transparent relative z-20">
            ...
            >
                <video
                    ref={videoRef}
                    src="https://cdn.pixabay.com/video/2023/04/09/158169-816245084_large.mp4"
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                    ...
                    >
                        {isPlaying ? <Pause className="fill-current w-5 h-5 md:w-6 md:h-6 lg:w-8 lg:h-8" /> : <Play className="fill-current w-5 h-5 md:w-6 md:h-6 lg:w-8 lg:h-8 ml-0.5 md:ml-1" />}
                    </motion.button>
                </div>
